    ...
    public partial class calisan_bilgi : Form
    {
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                SqlCommand rapor = new SqlCommand("insert into rapor(alici, saticilar, urun, miktar, fiyat, ortalamaFiyat, islemUcreti, Tarih) values(@Alici, @satici, @urun, @miktar, @fiyat, @ortFiyat, @IU, @tarih)", baglanti);
